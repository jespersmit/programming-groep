# Germany Air Quality Dataset (2014-2025)

**Format:** CSV (UTF-8) | **Records:** 10800 | **License:** CC BY-SA 4.0

## About This Dataset
This dataset tracks the synthesized air quality of Germany across 13 states mapping out 75 cities from North Rhine-Westphalia to Bavaria. It covers a twelve-year timeline (2014-2025), simulating significant localized pollution dynamics mapped directly to geographical layout and population distributions.

### Data Sources and Methodology

| Domain | Simulated Sources (Proxy Baselines) |
| ------------- |:-------------:|
| **Environmental Data** | [Umweltbundesamt (German Environment Agency)](https://www.umweltbundesamt.de/en) |
| **Socio-Economic Data** | [World Bank Germany Sector](https://data.worldbank.org/country) |
...
* **Realistic Weather & Seasonal Patterns**: Modes extreme weather, winter inversions, seasonal dust/precipitation, and traffic-derived emissions specific to Germany.
...
## Germany Administrative Level Coverage
...
*   Adjusted specifically to Germany's prevalent weather patterns such as winter inversions or local agricultural burnoff phenomenons.
