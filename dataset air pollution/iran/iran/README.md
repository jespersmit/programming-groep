# Iran Air Quality Dataset (2014-2025)

**Format:** CSV (UTF-8) | **Records:** 10800 | **License:** CC BY-SA 4.0

## About This Dataset
This dataset tracks the synthesized air quality of Iran across 16 major provinces mapping out 75 cities from Tehran to Sistan and Baluchestan. It covers a twelve-year timeline (2014-2025), simulating significant localized pollution dynamics mapped directly to geographical layout and population distributions.

### Data Sources and Methodology

| Domain | Simulated Sources (Proxy Baselines) |
| ------------- |:-------------:|
| **Air Quality Guidelines** | [Iran Department of Environment](https://doe.ir/en) & WHO |
| **Socio-Economic Data** | [World Bank Iran Sector](https://data.worldbank.org/country) |
...
* **Realistic Weather & Seasonal Patterns**: Modes extreme weather, winter inversions, seasonal dust/precipitation, and traffic-derived emissions specific to Iran.
...
## Iran Administrative Level Coverage
...
*   Adjusted specifically to Iran's prevalent weather patterns such as winter inversions or local agricultural burnoff phenomenons.
