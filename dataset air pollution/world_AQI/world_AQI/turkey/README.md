# Turkey Air Quality Dataset (2014-2025)

**Format:** CSV (UTF-8) | **Records:** 10800 | **License:** CC BY-SA 4.0

## About This Dataset
This dataset tracks the synthesized air quality of Turkey across 7 geographic regions mapping out 75 cities across Anatolia and Thrace. It covers a twelve-year timeline (2014-2025), simulating significant localized pollution dynamics mapped directly to geographical layout and population distributions.

### Data Sources and Methodology

| Domain | Simulated Sources (Proxy Baselines) |
| ------------- |:-------------:|
| **Environmental Data** | [Ministry of Environment, Urbanization and Climate Change (Turkey)](https://csb.gov.tr/) |
| **Socio-Economic Data** | [World Bank Turkey Sector](https://data.worldbank.org/country) |
...
* **Realistic Weather & Seasonal Patterns**: Modes extreme weather, winter inversions, seasonal dust/precipitation, and traffic-derived emissions specific to Turkey.
...
## Turkey Administrative Level Coverage
...
*   Adjusted specifically to Turkey's prevalent weather patterns such as winter inversions or local agricultural burnoff phenomenons.
