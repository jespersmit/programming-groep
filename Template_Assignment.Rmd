...
ghs_country_year <- ghs %>%
  ...
  summarise(
    ...
    incidence_rate_percent = mean(.data$incidence_rate_percent, na.rm = TRUE),
    mortality_rate_percent = mean(.data$mortality_rate_percent, na.rm = TRUE),
    recovery_rate_percent = mean(.data$recovery_rate_percent, na.rm = TRUE),
    per_capita_income_usd = mean(.data$per_capita_income_usd, na.rm = TRUE),
    education_index = mean(.data$education_index, na.rm = TRUE),
    urbanization_rate_percent = mean(.data$urbanization_rate_percent, na.rm = TRUE),
    .groups = "drop"
  )
...
ghs_country_year$country <- countrycode::countrycode(
